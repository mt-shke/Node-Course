...
<details>
<summary>fileupload unlinkSync</summary>

<details>
<summary>express file upload</summary>
...
<details>
<summary>nodemailer - sendgrid</summary>
...
```js
// .env SECRET_KEY(back-end) + PUBLIC_KEY(front-end )
...
- Basics & Server Start - DB - basics routes & middleware + morgan
- models
...
<details>
<summary>Schema - mongoose validate - validator package</summary>
...
<details>
<summary>using CRA</summary>

app => cors

```js
// can only use cookie, send them back, on same domain
const cors = require("cors");
...
<details>
<summary>cookie - auth middleware</summary>
...
```js
// those routes are only accessible for logged in user now
// authenticateUser middleware blocks route
...
<details>
<summary>mongoose: findOneAndUpdate - user.save()</summary>
...
<details>
<summary>uploadimage - express file upload</summary>
...
<details>
<summary>mongoose Schema pre hook remove</summary>
...
<details>
<summary>aggregate pipeline</summary>
...
<details>
<summary>orderController with stripe</summary>
...
<details>
<summary>Docgen</summary>

```js
// download docgen and place in same folder as docs.json (from postman export)
// https://github.com/thedevsaddam/docgen/releases/tag/v3.3.0
// then use in cli
...
<details>
<summary>extra package - secure rateLimiter cors mongo sanitize etc</summary>
...
<details>
<summary>Refactoring: Schema - authController</summary>
...
module.exports = {
	...
	port: 587,
	auth: {
		user: "kqzbuslppwuq7ns4@ethereal.email",
		pass: "WSQc4wr35yMFhbCA6c",
	},
};
```
...
<details>
<summary>sendEmailVerification</summary>
...
<details>
<summary>Token model - refreshToken + accessToken - consumming tokens</summary>
...
<details>
<summary>sendEmailPassword</summary>
...
const resetPassword = async (req, res) => {
	...
	if (user) {
		...
		if (user.passwordToken === token && user.passwordTokenExpirationDate > currentDate) {
			user.password = createHash(passwordToken);
